...
_api2['default'].post('/apps/' + _environment.appConf.app.id + '/js_versions', { attachments: [{ field: 'jsbundle', path: _path2['default'].join(process.cwd(), 'iOS/main.jsbundle') }, { field: 'package_json', path: _path2['default'].join(process.cwd(), 'package.json') }] }).then(function (response) {
