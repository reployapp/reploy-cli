    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return regeneratorRuntime.awrap((0, _api.getApplication)(_environment.appConf.app.id));
        ...
        case 4:
          ...
          _context.next = 10;
          return regeneratorRuntime.awrap(uploadBuild(buildPath));
        ...
        case 10:
          ...
          _context.next = 16;
          return regeneratorRuntime.awrap(uploadToAppetize(uploadId, { appetizePrivateKey: appetizePrivateKey, platform: platform }));
        ...
        case 18:
          _context.next = 20;
          return regeneratorRuntime.awrap(uploadToAppetize(uploadId, { platform: platform }));

        case 20:
          appetizeData = _context.sent;
          _context.next = 23;
          return regeneratorRuntime.awrap(addAppetizeIdToReploy(appetizeData, platform));
...
function addAppetizeIdToReploy(appetizeData, platform) {
  var data;
  return regeneratorRuntime.async(function addAppetizeIdToReploy$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 5;
          return regeneratorRuntime.awrap((0, _api.mutation)('updateApplication', data));
...
function addBuildtoReploy(uploadId, platform) {
  var response;
  return regeneratorRuntime.async(function addBuildtoReploy$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return regeneratorRuntime.awrap((0, _api.mutation)('createBinaryUpload', {
            uploadId: uploadId,
...
function uploadBuild(filePath) {
  var bar, response;
  return regeneratorRuntime.async(function uploadBuild$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.prev = 2;
          _context4.next = 5;
          return regeneratorRuntime.awrap(superagent.post('https://upload.uploadcare.com/base/').field('UPLOADCARE_PUB_KEY', '9e1ace5cb5be7f20d38a').attach('file', filePath).on('progress', function (progress) {
            if (!bar.completed) {
...
function uploadToAppetize(uploadId) {
  ...
  return regeneratorRuntime.async(function uploadToAppetize$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 5;
          _context5.next = 8;
          return regeneratorRuntime.awrap(superagent.post('https://webtask.it.auth0.com/api/run/wt-joshua-diluvia_net-0').set('Authorization', 'Bearer ' + webtaskToken).send({ params: params }));
