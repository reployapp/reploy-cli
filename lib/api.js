...
var query = exports.query = (function () {
  var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee3(query) {
    var result;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 9:
            return _context3.abrupt('return', result.data.viewer);
...
var mutation = exports.mutation = (function () {
  var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee4(name, input) {
    var _result;
