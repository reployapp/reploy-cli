...
var run = (function () {
  var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee() {
    var jsPath, user, platform, bundleCommand, uploadcareId, bar;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            bundleCommand = (0, _child_process.spawnSync)('react-native', ['bundle', '--entry-file', './index.ios.js', '--platform', platform, '--bundle-output', jsPath]);
