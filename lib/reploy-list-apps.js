          ...
          case 3:
            ...
            if (applications.count === 0) {
              ...
              applications.nodes.forEach(function (app) {
                table.push([app.urlToken, app.name, app.screenshots.count, app.invitedUsers.count]);
              });
...
var table = new _cliTable2.default({
  head: [_colors2.default.cyan('ID'), _colors2.default.cyan('Name'), _colors2.default.cyan('Screenshots'), _colors2.default.cyan('Testers')],
