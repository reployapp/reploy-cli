...
_superagent2.default.post('https://upload.uploadcare.com/base/').field("UPLOADCARE_PUB_KEY", '9e1ace5cb5be7f20d38a').attach('file', jsPath).on('progress', function (progress) {
  if (!bar.complete) {
