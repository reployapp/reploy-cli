...
var createDevice = (function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(device, index) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            _context3.next = 9;
            return _promise2.default.all(DEVICES.map(createDevice));
