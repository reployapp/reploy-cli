...
if (!_environment.appConf.app) {
  ...
  _superagent2['default'].get('http://reploy.io/api/v1/apps/' + _environment.appConf.app.id + '/' + _environment.appVersion + '/js_versions').set("X-ApiId", _environment.globalConf.apiId).set("X-ApiSecret", _environment.globalConf.apiSecret).end(function (err, response) {
