      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            _context.prev = 7;
            _context.next = 10;
            return _api.request.post((_commander2.default.githubApiPrefix || "https://api.github.com/repos") + '/' + _commander2.default.repositoryName + '/statuses/' + _commander2.default.commitHash + '?access_token=' + _commander2.default.githubToken).send({
              "state": "success",
