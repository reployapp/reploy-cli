...
function buildAndroid() {
  ...
  if (!_commander2.default.skip) {
    ...
    (0, _child_process.spawnSync)('./gradlew', ['assembleRelease']);
  }
  console.log("Done!");
}
...
var addBuildtoReploy = function () {
  var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee3(uploadId, platform) {
    var response;
...
function createBuildZipFile() {
  ...
  if (!_commander2.default.skip) {
    ...
    var buildCommand = (0, _child_process.spawnSync)('xctool', buildArray);
