...
var REPLOY_TOKEN = _process2.default.env.REPLOY_TOKEN_DEV;

if (_process2.default.env.REPLOY_ENV == 'production') {
  var REINDEX_DATABASE = 'practical-improvement-29';
  var REINDEX_TOKEN = _process2.default.env.REINDEX_TOKEN_PROD;
  var REPLOY_TOKEN = _process2.default.env.REPLOY_TOKEN;
}

var db = new _reindexJs2.default('https://' + REINDEX_DATABASE + '.myreindex.com');
var TOKEN = _process2.default.env.REPLOY_ADMIN ? REINDEX_TOKEN : REPLOY_TOKEN;

if (!TOKEN) {
  if (!_process2.default.env.REPLOY_ADMIN) {
