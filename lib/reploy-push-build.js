      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            (0, _postBuildUpload.uploadBuild)(platform, { buildPath: _commander2.default.buildPath, applicationId: _commander2.default.applicationId, name: _commander2.default.name });
...
if (_commander2.default.token) {
  ...
  _cli2.default.debug('supplied token ' + _commander2.default.token);
}
